  ...
  return (
    ...
    >
      <div className="grid h-full w-full place-content-center px-4 py-12 md:w-2/5 md:px-8 md:py-8">
        ...
        >
          <span className="rounded-full bg-custom-accent px-2 py-1.5 text-xs font-medium text-white">
...
const ExampleFeature = ({ featureInView }) => {
  return (
    <div className="relative h-96 w-full rounded-xl bg-bg-color">
      ...
      <div className="p-2">
        <p className="font-mono text-sm text-slate-900">
          <span className="text-slate-900">~</span> Show a part of your product
          that explains what{" "}
          <span className="inline-block text-white rounded bg-custom-accent px-1 font-semibold">
            "{featureInView.title}"
          </span>{" "}
          means.
        </p>
